...
public class DependencyInjectionTest {
     ...
     * and add annotation in StubAccountRepository in order to get this test to run.
     * <p/>
    ...
    /**
     * Add neccecary annotations to AuctionService in order to get this test to run.
     * <p/>
     * TIP: The repository implementation is:
